...
/* eslint-disable max-classes-per-file */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$serialization$2f$xdr$2d$reader$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@stellar/js-xdr/src/serialization/xdr-reader.js [app-ssr] (ecmascript)");
...
class NestedXdrType extends XdrCompositeType {
   ...
   */ static checkDepth(remainingDepth) {
        ...
        if (remainingDepth < 0) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["XdrReaderError"]('exceeded max decoding depth');
        }
    }
}
...
;
;
class Array extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"] {
    constructor(childType, length, maxDepth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"].DEFAULT_MAX_DEPTH){
        super(maxDepth);
   ...
   */ read(reader, remainingDepth = this._maxDepth) {
        ...
        if (this._length > reader.remainingBytes()) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["XdrReaderError"](`Array length ${this._length} exceeds remaining ${reader.remainingBytes()} bytes`);
        }
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"].checkDepth(remainingDepth);
        const result = [];
        // read values
...
;
;
class VarArray extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"] {
    constructor(childType, maxLength = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$unsigned$2d$int$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UnsignedInt"].MAX_VALUE, maxDepth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"].DEFAULT_MAX_DEPTH){
        super(maxDepth);
        this._childType = childType;
        this._maxLength = maxLength;
    }
   ...
   */ read(reader, remainingDepth = this._maxDepth) {
        ...
        if (length > reader.remainingBytes()) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["XdrReaderError"](`VarArray length ${length} exceeds remaining ${reader.remainingBytes()} bytes`);
        }
        const result = [];
...
;
;
class Option extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"] {
    constructor(childType, maxDepth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"].DEFAULT_MAX_DEPTH){
        super(maxDepth);
        this._childType = childType;
    }
    /**
...
;
;
class Struct extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"] {
   ...
   */ static isValid(value) {
    ...
    static create(context, name, fields, maxDepth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"].DEFAULT_MAX_DEPTH) {
...
;
;
class Union extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"] {
   ...
   */ static isValid(value) {
    ...
    static create(context, name, config, maxDepth = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$js$2d$xdr$2f$src$2f$xdr$2d$type$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NestedXdrType"].DEFAULT_MAX_DEPTH) {
...
"[project]/node_modules/smart-account-kit-bindings/dist/index.js [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$lib$2f$contract$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@stellar/stellar-sdk/lib/contract/index.js [app-ssr] (ecmascript)");
...
const SpendingLimitError = {
     ...
     */ 3224: {
        message: "HistoryCapacityExceeded"
    }
};
const SimpleThresholdError = {
    /**
...
const WebAuthnError = {
     ...
     */ 3110: {
        message: "SignaturePayloadInvalid"
    },
    /**
     * The client data exceeds the maximum allowed length.
     */ 3111: {
        message: "ClientDataTooLong"
    },
    /**
...
const MerkleDistributorError = {
     ...
     */ 1301: {
        message: "IndexAlreadyClaimed"
    },
    /**
     * The proof is invalid.
     */ 1302: {
        message: "InvalidProof"
    }
};
const SorobanFixedPointError = {
    /**
...
const CryptoError = {
     ...
     */ 1400: {
        message: "MerkleProofOutOfBounds"
    },
    /**
     * The index of the leaf is out of bounds.
     */ 1401: {
        message: "MerkleIndexOutOfBounds"
    },
    /**
     * No data in hasher state.
     */ 1402: {
        message: "HasherEmptyState"
    }
};
const PausableError = {
    /**
...
class Client extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$lib$2f$contract$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Client"] {
    options;
    static async deploy(/** Constructor/Initialization Args for the contract's `__constructor` method */ { signers, policies }, /** Options for initializing a Client as well as for calling a method, with extras specific to deploying. */ options) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$lib$2f$contract$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Client"].deploy({
            signers,
            policies
        }, options);
    }
    constructor(options){
        super(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$lib$2f$contract$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Spec"]([
...
"[project]/node_modules/base64url/dist/pad-string.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/base64url/dist/base64url.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
var pad_string_1 = __turbopack_context__.r("[project]/node_modules/base64url/dist/pad-string.js [app-ssr] (ecmascript)");
...
"[project]/node_modules/base64url/index.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = __turbopack_context__.r("[project]/node_modules/base64url/dist/base64url.js [app-ssr] (ecmascript)").default;
module.exports.default = module.exports;
}),
];

//# sourceMappingURL=node_modules_0r9o3.i._.js.map